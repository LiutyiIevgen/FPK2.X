...
//Set Filters
    ...
    CAN1SetFilter(0, CAN_FILTER_SID(0x480 + node_id - 1) & CAN_RX_EID_DIS, CAN_FILTER_EID(00000));
    CAN1SetMask(0, CAN_MASK_SID(0x7FF) & CAN_MATCH_FILTER_TYPE, CAN_MASK_EID(00000));
    CAN1SetFilter(1, CAN_FILTER_SID(0x480 + node_id - 1) & CAN_RX_EID_DIS, CAN_FILTER_EID(00000));
